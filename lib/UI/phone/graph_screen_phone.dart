...
class GraphScreenPhone extends StatefulWidget {
  const GraphScreenPhone({Key? key}) : super(key: key);

  @override
  State<GraphScreenPhone> createState() => _GraphScreenPhoneState();
}

class _GraphScreenPhoneState extends State<GraphScreenPhone> {
